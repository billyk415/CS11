 ...
 * lab5
 * 
 * Note: All line numbers written are after comment changes.
 * Three errors fixed:
 * 1.) In what is now line 38(previously 125), ">=" instead of ">" was used to indicate the allowed upper range of sentenceCode as [1-5) rather than [1-5]. 
 * 2.) In what is now line 79(previously 166), an extra semicolon after "else" was used, ending an if-else-if chain.  
 * 3.) In what is now line 98(previously 185), an extra semicolon after "if(m==2)" was used, making it a conditional with no resulting action- more importantly, making line 100: word="foggy" which the if statement was supposed to correspond to.
 *
 */
